...
<div class="portfolio-grid">
  ...
  <div class="project-card">
    ...
    <p class="project-desc">
      Collaborated with the Postman API engineering team to refine the public API workspace. Focused on structural clarity in OpenAPI definitions to ensure auto-generated documentation remained accurate and user-friendly.
    </p>
  ...
  <div class="project-card">
    <div class="tag-container">
      ...
      <span class="tag">Technical Review</span>
    </div>
...
<div class="portfolio-grid">
  <div class="project-card">
    <div class="tag-container">
      ...
      <span class="tag">Markdown Templates</span>
    </div>
